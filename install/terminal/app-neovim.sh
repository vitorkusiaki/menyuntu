...
if [ ! -d "$HOME/.config/nvim" ]; then
  ...
  cp ~/.local/share/menyuntu/configs/neovim/transparency.lua ~/.config/nvim/plugin/after/

  # Default to Tokyo Night theme
  cp ~/.local/share/menyuntu/themes/tokyo-night/neovim.lua ~/.config/nvim/lua/plugins/theme.lua
