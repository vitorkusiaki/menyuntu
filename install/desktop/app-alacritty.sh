...
cp ~/.local/share/menyuntu/themes/tokyo-night/alacritty.toml ~/.config/alacritty/theme.toml
cp ~/.local/share/menyuntu/configs/alacritty/fonts/CaskaydiaMono.toml ~/.config/alacritty/font.toml
cp ~/.local/share/menyuntu/configs/alacritty/font-size.toml ~/.config/alacritty/font-size.toml
...
source ~/.local/share/menyuntu/install/desktop/set-alacritty-default.sh
