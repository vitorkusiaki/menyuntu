...
cp ~/.local/share/menyuntu/configs/ulauncher.desktop ~/.config/autostart/ulauncher.desktop
gtk-launch ulauncher.desktop >/dev/null 2>&1
sleep 2 # ensure enough time for ulauncher to set defaults
cp ~/.local/share/menyuntu/configs/ulauncher.json ~/.config/ulauncher/settings.json
